<div id="content_wrapper">
		<div id="contactform">
			<?php echo form_open('contact/contact_form'); ?>
				<h2>Your Name</h2><p><input type="text" label="name" name="name" class="largeinput" /></p>
				<h2>Your Email</h2><p><input type="text" label="email" name="email" class="largeinput"/></p>
				<h2>Message</h2><p><textarea label="message" name="message" rows="10" cols="40"></textarea></p>
